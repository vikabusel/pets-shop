...
function searchCard() {
  ...
  const searchResult = items.filter((item) => item.title.toLowerCase().trim().includes(searchString));
  ...
  searchResult.forEach((item) => {
    productCardTemplate(item.title, item.description, item.img, item.price, item.tags);
  });
};
